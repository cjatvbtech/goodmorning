        ...
        <div class="card-body p-b-0">
            <div class="row">
                ...
                <div class="col-sm-8 p-t-20">
                    <span class="c-blue"><strong>Loan application for {{ $product->name }}</strong></span>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="c-black">No. of items</label>
                        <select class="form-control" name="number_of_items">
                            @for ($i = 1; $i <= 10; $i++)
                            <option value="{{ $i }}">{{ $i }}</option>
                            @endfor
                        </select>
                        @if ($errors->has('number_of_items'))
                        <p class="">{{ $errors->first('number_of_items') }}</p>
                        @endif
                    </div>
                </div>
            </div>
